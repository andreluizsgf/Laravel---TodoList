      ...
      <div class="card-body login-card-body">
        ...
        <form action="{{route('login')}}" method="post">
          ...
          <div class="input-group mb-3">
            <input name="name" type="text" autocomplete="username" class="form-control" placeholder="Nome">
            <div class="input-group-append input-group-text">
              <span class="fas fa-envelope"></span>
            </div>
          </div>
          <div class="input-group mb-3">
            <input name="password" type="password" autocomplete="current-password" class="form-control" placeholder="Senha">
            <div class="input-group-append input-group-text">
